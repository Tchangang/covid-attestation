export default {
    travail: ['Déplacements entre le domicile et le lieu d’exercice de l’activité professionnelle ou un',
    ...
    sante: ['Consultations, examens et soins ne pouvant être assurés à distance et l’achat de',
        'médicaments.'],
    famille: ['Déplacements pour motif familial impérieux, pour l\'assistance aux personnes vulnérables et',
        'précaires ou la garde d\'enfants.'],
    handicap: ['Déplacement des personnes en situation de handicap et leur accompagnant.'],
    sport_animaux: ['Déplacements brefs, dans la limite d\'une heure quotidienne et dans un rayon maximal d\'un',
